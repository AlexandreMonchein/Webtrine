...
export const Default: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Configuration complète avec localisation, informations de contact et horaires d'ouverture.",
      },
    },
  },
};
...
export const SimpleLocation: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Version simplifiée sans horaires d'ouverture, seulement la localisation et l'adresse.",
      },
    },
  },
};
...
export const MultipleLocations: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Exemple avec plusieurs localisations affichées sur la même carte.",
      },
    },
  },
};
