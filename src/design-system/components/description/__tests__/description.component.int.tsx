...
describe('Description Component', () => {
  ...
  it('renders image when provided', () => {
    ...
    expect(image).toHaveAttribute('src', expect.stringContaining('test_image.webp'));
  });
  ...
  it('handles mixed content types correctly', () => {
    ...
    expect(screen.getByRole('link', { name: 'Primary Action' })).toBeInTheDocument();
    expect(screen.getByText('Middle text content.')).toBeInTheDocument();
    expect(screen.getByRole('link', { name: 'Secondary Action' })).toBeInTheDocument();
