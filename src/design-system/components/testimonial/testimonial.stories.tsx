...
import type { TestimonialComponentProps, Testimonial } from './testimonial.types';
...
const mockTestimonials: Testimonial[] = [
  ...
  },
  {
    ...
    company: 'InnovateNow',
    rating: 5,
    content: 'Un travail de qualité exceptionnelle. L\'attention aux détails et la passion pour l\'excellence sont remarquables. Je travaillerai à nouveau avec eux sans hésiter.',
    date: '2023-12-28'
  },
  {
    id: '5',
    ...
    rating: 4,
    content: 'Une collaboration fluide et enrichissante. Ils ont su s\'adapter à nos contraintes et proposer des solutions innovantes. Résultat au-delà de nos espérances.',
