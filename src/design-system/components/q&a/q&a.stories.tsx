...
\`\`\`
  ...
  argTypes: {
    ...
    content: {
      description: "Contenu des questions-réponses (catégories ou items directs)",
      control: { type: "object" },
    },
  },
};
...
const basicItems: QAItem[] = [
  {
    ...
    answer: "<p>Vous pouvez prendre rendez-vous par téléphone au <strong>01 23 45 67 89</strong> ou directement en ligne via notre formulaire de contact.</p>",
  },
  {
    id: "basic-2",
    question: "Quels sont vos horaires d'ouverture ?",
    answer: "<p>Nous sommes ouverts :</p><ul><li>Du lundi au vendredi : 9h - 18h</li><li>Samedi : 10h - 16h</li><li>Dimanche : Fermé</li></ul>",
  },
  {
    id: "basic-3",
    question: "Acceptez-vous les cartes de crédit ?",
    answer: "<p>Oui, nous acceptons toutes les cartes de crédit principales ainsi que les paiements en espèces et par chèque.</p>",
  },
];
    ...
    items: [
      {
        ...
        answer: "<p>Pour prendre rendez-vous, vous pouvez :</p><ul><li>Nous appeler au <strong>01 23 45 67 89</strong></li><li>Passer directement au studio</li><li>Nous envoyer un message via nos réseaux sociaux</li></ul><p>Nous vous conseillons de prévoir votre rendez-vous <em>au moins 2 semaines à l'avance</em>.</p>",
      },
      {
        id: "gen-2",
        question: "Quel est l'âge minimum pour se faire tatouer ?",
        answer: "<p>L'âge minimum légal est de <strong>18 ans</strong>. Aucune exception ne peut être faite, même avec une autorisation parentale.</p><p>Une pièce d'identité valide sera demandée avant toute séance.</p>",
      },
      {
        id: "gen-3",
        question: "Combien coûte un tatouage ?",
        answer: "<p>Le prix dépend de plusieurs facteurs :</p><ul><li><strong>Taille</strong> : de 80€ pour un petit motif à plusieurs centaines d'euros</li><li><strong>Complexité</strong> : détails, couleurs, style</li><li><strong>Emplacement</strong> : certaines zones sont plus techniques</li><li><strong>Durée</strong> : tarif horaire de 120€/h</li></ul><p>Un devis personnalisé vous sera fourni lors de la consultation.</p>",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: "<p>Pour optimiser votre séance :</p><ul><li><strong>Dormez bien</strong> la nuit précédente</li><li><strong>Mangez</strong> avant de venir (évitez d'être à jeun)</li><li><strong>Hydratez-vous</strong> correctement</li><li><strong>Évitez l'alcool</strong> 24h avant</li><li><strong>Portez des vêtements confortables</strong></li></ul>",
      },
      {
        id: "prep-2",
        question: "Puis-je prendre des antidouleurs avant ?",
        answer: "<p><strong>Non</strong>, il est déconseillé de prendre des antidouleurs avant une séance :</p><ul><li>L'aspirine fluidifie le sang</li><li>Certains médicaments peuvent affecter la cicatrisation</li><li>Votre tatoueur a besoin de votre ressenti naturel</li></ul><p>Si vous avez des doutes, consultez votre médecin.</p>",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: "<p>Les soins post-tatouage sont cruciaux :</p><ol><li><strong>Gardez le film protecteur</strong> 2-4 heures</li><li><strong>Nettoyez délicatement</strong> à l'eau tiède et savon neutre</li><li><strong>Séchez en tamponnant</strong> (ne frottez pas)</li><li><strong>Appliquez une crème cicatrisante</strong> 2-3 fois par jour</li><li><strong>Évitez les vêtements serrés</strong> sur la zone</li></ol>",
      },
      {
        id: "after-2",
        question: "Combien de temps dure la cicatrisation ?",
        answer: "<p>La cicatrisation se déroule en plusieurs phases :</p><ul><li><strong>3-7 jours</strong> : Formation de croûtes</li><li><strong>1-2 semaines</strong> : Desquamation</li><li><strong>1 mois</strong> : Cicatrisation superficielle complète</li><li><strong>2-3 mois</strong> : Cicatrisation profonde</li></ul><p>Le tatouage peut paraître terne pendant cette période, c'est normal !</p>",
      },
      {
        id: "after-3",
        question: "Que faire si mon tatouage s'infecte ?",
        answer: "<p><strong>Signes d'infection :</strong></p><ul><li>Rougeur excessive et chaude</li><li>Gonflement important</li><li>Pus ou écoulement malodorant</li><li>Fièvre</li></ul><p><strong>En cas d'infection :</strong></p><ol><li>Consultez immédiatement un médecin</li><li>Ne touchez pas à la zone infectée</li><li>Continuez les soins d'hygiène</li><li>Contactez votre tatoueur</li></ol>",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer: "<p>La reprise du sport dépend de l'emplacement du tatouage :</p><ul><li><strong>Sport léger</strong> : 48-72 heures</li><li><strong>Musculation/sport intense</strong> : 1-2 semaines</li><li><strong>Sports aquatiques</strong> : 3-4 semaines minimum</li></ul><p>Évitez de faire transpirer excessivement la zone tatouée pendant la cicatrisation.</p>",
      },
      {
        id: "rest-2",
        question: "Puis-je me baigner après un tatouage ?",
        answer: "<p><strong>À éviter absolument</strong> pendant la cicatrisation :</p><ul><li>Piscines (chlore irritant)</li><li>Mer (sel et bactéries)</li><li>Bains chauds</li><li>Saunas et hammams</li></ul><p>Les douches rapides sont autorisées, mais évitez de faire tremper le tatouage.</p>",
      },
    ],
  },
];
      ...
      items: [
        {
          ...
          answer: "<p>Vous pouvez nous contacter par :</p><ul><li>Téléphone : <strong>01 23 45 67 89</strong></li><li>Email : <strong>contact@example.com</strong></li><li>En personne dans nos locaux</li></ul>",
        },
      ],
    },
  },
      ...
      categories: [
        {
          ...
          items: [
            {
              id: "long-1",
              question: "Voici une question très longue qui pourrait s'étendre sur plusieurs lignes pour tester l'affichage responsive ?",
              answer: `
