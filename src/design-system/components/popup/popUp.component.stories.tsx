...
const meta: Meta<typeof PopUpComponent> = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Composant PopUp pour afficher des notifications avec auto-fermeture et barre de progression.'
      }
    }
  }
};
...
export const WarningPopup: Story = {
  args: {
    storeState: {
      showPopUp: true,
      type: 'warning',
      message: "Attention ! Cette action est irréversible. Veuillez confirmer votre choix.",
      error: null
    }
  },
  parameters: {
...
export const LongMessage: Story = {
  args: {
    storeState: {
      showPopUp: true,
      type: 'success',
      message: "Félicitations ! Votre commande a été validée avec succès. Vous recevrez un email de confirmation dans les prochaines minutes avec tous les détails de votre achat. Notre équipe préparera votre commande dans les plus brefs délais.",
      error: null
    }
  },
  parameters: {
    docs: {
      description: {
        story: 'PopUp avec un message long pour tester l\'affichage du contenu étendu.'
      }
    }
  }
};
